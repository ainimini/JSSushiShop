...
import com.junshou.service.goods.service.BrandService;
...
public class BrandController {
     ...
     * @description:
     * @author: X
     * @updateTime: 2020/2/1 9:27
     * @return:
     * @param:
     * @throws:
     */
    @GetMapping(value = "/category/{categoryId}")
    public Result<List<Brand>> findBrandByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        List<Brand> brandByCategoryId = brandService.findBrandByCategoryId(categoryId);
        return new Result<List<Brand>>(true, StatusCode.OK, "成功查询品牌", brandByCategoryId);
    }
