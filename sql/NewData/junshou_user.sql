...
INSERT INTO `oauth_client_details` VALUES ('junshou', NULL, '$2a$10$tQEf/3PcAiM8XFieF6JbC.ygDofqozMPDNIItgfg5J30.A0Hd0Iam', 'app', 'authorization_code,password,refresh_token,client_credentials', 'http://localhost', NULL, 43200, 43200, NULL, NULL);
...
CREATE TABLE `tb_user`  (
  `username` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名作为主键',
  ...
  `source_type` int(1) NULL DEFAULT NULL COMMENT '会员来源：1:PC，2：H5，3：Android，4：IOS',
  `nick_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '昵称',
  `status` int(1) NULL DEFAULT NULL COMMENT '使用状态（1正常 0非正常）',
  ...
  `is_mobile_check` int(1) NULL DEFAULT 0 COMMENT '手机是否验证 （0否  1是）',
  `is_email_check` int(1) NULL DEFAULT 0 COMMENT '邮箱是否检测（0否  1是）',
  `sex` int(1) NULL DEFAULT 1 COMMENT '性别，1男，0女',
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('111', '$2a$10$E0Irh0ewwKTTslBUgRTebOa2LeKWXvND0kynhFP2CnIKSfCN1YEzS', '111', '111', '2020-02-04 18:20:03', NULL, 1, '1', 1, '1', '1', 1, 1, 1, 1, 135, 1, '2018-08-07', NULL);
